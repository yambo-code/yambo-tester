...
- Planned the executable refactor and chose a registry-based configuration design.
- Confirmed the required executables are `yambo`, `p2y`, and `a2y`.
